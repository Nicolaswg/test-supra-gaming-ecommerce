              ...
              <div className="max-w-[500px] absolute left-8 lg:left-20 top-1/2 -translate-y-1/2 z-20">
                ...
                <h1 className="font-bold text-white text-2xl sm:text-[42px] mb-4 leading-tight drop-shadow-lg">
                  <Link
                    ...
                    className="hover:text-blue-light transition-colors duration-300"
                  >
                    {slider?.product?.name}
                  </Link>
                </h1>
                ...
                <Link
                  href={`/products/${slider?.product?.slug.current}`}
                  className="inline-flex items-center gap-2 font-semibold text-white text-base rounded-full bg-blue py-4 px-10 ease-out duration-300 hover:bg-blue-dark hover:scale-105 transform shadow-lg hover:shadow-xl"
                >
                  comprar ahora
