      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 xl:px-0">
        <div className="flex flex-col xl:flex-row gap-6">
          <div className="xl:w-2/3 w-full">
            <div className="relative z-1 rounded-2xl bg-white overflow-hidden shadow-lg">
              <HeroCarousel sliders={sliders} />
            </div>
          </div>

          <div className="xl:w-1/3 w-full flex flex-col justify-between sm:flex-row xl:flex-col gap-6">
